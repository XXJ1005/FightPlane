...
/******************************************************************************/
#pragma once
#ifndef FRKEMITTERSTRING_H
#define FRKEMITTERSTRING_H

#include "FrkEmitterShape.h"

/************************************************************************/
//	Class:			FrkEmitterString
//	Description:	Holds the String Shaped particle emitter object.
/************************************************************************/
class FrkEmitterString : public FrkEmitterShape
{
public:
	FrkEmitterString();
