...
/******************************************************************************/
#pragma once
#ifndef FRKEMITTERPOINT_H
#define FRKEMITTERPOINT_H
...
/************************************************************************/
//	Class:			FrkEmitterPoint
//	Description:	Holds the Point Shaped particle emitter object.
/************************************************************************/
class FrkEmitterPoint : public FrkEmitterShape
{
public:
	FrkEmitterPoint();

	const int SubmitShape(_t_frkPEmitter* pEmitter, _t_frkParticle* pParticle);
	virtual const int SubmitShape(void* pBufferEmitter, void* pBufferParticle);
	const int SetQuadAxis(const t_frkVector3& Up, const t_frkVector3& Right, const t_frkVector3& Rot);
